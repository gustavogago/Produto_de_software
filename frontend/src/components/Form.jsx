...
function Form({ route, method }) {
  ...
  // Estado inicial diferente para login e registro
  const initialData =
    method === "login"
      ? { username: "", password: "" }
      : { 
